...
const LevelCompPq2 = () => {
  ...
  // FETCH FILES (ONLY CHANGE IS LEVEL = 200)
  useEffect(() => {
    const fetchFiles = async () => {
      try {
        const res = await fetch("http://localhost/pidify/pidify/getFiles.php?level=200");
        ...
        <section className="flex-1 p-6 md:p-8 bg-gray-50 min-h-screen overflow-y-auto">
          ...
          <div className="mb-8">
            <h1 className="text-1.5xl md:text-1.5xl font-semibold text-gray-800 mb-4">
              Access 200 Level Past Questions
            </h1>
          ...
          <nav className="flex flex-wrap gap-3 mb-6">
            <Link to="/computer-science/100level"
              className="px-4 py-2 bg-white text-gray-700 border rounded-lg">
              100 LVL
            </Link>

            <Link to="/computer-science/200level"
              className="px-4 py-2 bg-[#006666] text-white rounded-lg">
              200 LVL
            </Link>

            <Link to="/computer-science/300level"
              className="px-4 py-2 bg-white text-gray-700 border rounded-lg">
              300 LVL
            </Link>

            <Link to="/computer-science/400level"
              className="px-4 py-2 bg-white text-gray-700 border rounded-lg">
              400 LVL
            </Link>
          </nav>
