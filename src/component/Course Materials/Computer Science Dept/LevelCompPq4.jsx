...
const LevelCompPq4 = () => {
  ...
  // HEADER STATES (same as LevelComp1)
  ...
  useEffect(() => {
    const fetchFiles = async () => {
      try {
        const res = await fetch("http://localhost/pidify/pidify/getFiles.php?level=400&type=pq_comp");
  ...
  return (
    <div className="flex bg-gray-100 w-full overflow-x-hidden">
      <div className="flex-1 flex flex-col w-full min-w-0">
        ...
        {/* NAVBAR (SAME AS LEVELCOMP1 — NO DESIGN CHANGE) */}
        ...
        <section className="flex-1 p-6 md:p-8 bg-gray-50 min-h-screen overflow-y-auto">
          ...
          <div className="mb-8">
            <h1 className="text-1.5xl md:text-1.5xl font-semibold text-gray-800 mb-4">
              Access 400 Level Past Questions
            </h1>
          ...
          <nav className="flex flex-wrap gap-3 mb-6">
            ...
            <Link to="/computer-science/300level" className="px-4 py-2 bg-white text-gray-700 border rounded-lg">
              300 LVL
            </Link>

            <Link to="/computer-science/400level" className="px-4 py-2 bg-[#006666] text-white rounded-lg">
              400 LVL
            </Link>
          </nav>
