...
const LevelSoftPq1 = () => {
  ...
  useEffect(() => {
    fetch(
      "http://localhost/pidify/pidify/getFiles.php?level=100&type=pq_soft"
    )
      .then((res) => res.json())
    ...
    <div className="flex bg-gray-100 w-full overflow-x-hidden">
      <div className="flex-1 flex flex-col w-full min-w-0">
        ...
        <section className="flex-1 p-6 md:p-8 bg-gray-50 min-h-screen overflow-y-auto">
          <div className="mb-8">
            <h1 className="text-1.5xl font-semibold text-gray-800 mb-4">
              Access 100 Level Software Engineering Past Questions
            </h1>
          ...
          <nav className="flex flex-wrap gap-3 mb-6">
            <Link to="/software-engineering-pq/100" className="px-4 py-2 bg-[#006666] text-white rounded-lg">100 LVL</Link>
            <Link to="/software-engineering-pq/200" className="px-4 py-2 bg-white border rounded-lg">200 LVL</Link>
            <Link to="/software-engineering-pq/300" className="px-4 py-2 bg-white border rounded-lg">300 LVL</Link>
            <Link to="/software-engineering-pq/400" className="px-4 py-2 bg-white border rounded-lg">400 LVL</Link>
          </nav>
