  ...
  return (
   <div className="flex bg-gray-100 w-full overflow-x-hidden">
      ...
      <section className="flex-1 p-6 md:p-8 bg-gray-50 min-h-screen overflow-y-auto">
        <div className="mb-8">
          <h1 className="text-1.5xl md:text-1.5xl font-semibold text-gray-800 mb-4">Access 200 Level Micro-Biology Past Questions</h1>
        ...
        <nav className="flex flex-wrap gap-3 mb-6">
          ...
          <Link to="/micro-biology-pq/200" className="px-4 py-2 bg-[#006666] text-white rounded-lg">200 LVL</Link>
