...
const RegisterUser = () => {
  ...
  // 🔐 PASSKEY (change this later or move to backend)
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      // ✅ DETERMINE ROLE
      const role = userType === "official" ? "official" : "student";
        ...
        <div className="w-full max-w-4xl lg:max-w-5xl flex flex-col lg:flex-row gap-6 lg:gap-8 items-center lg:items-stretch">
          ...
          <div className="w-full lg:w-3/5 bg-white/95 backdrop-blur-sm rounded-2xl shadow-2xl p-4 sm:p-6 md:p-7 border border-white/20 h-fit">
            ...
            <h2 className="text-xl sm:text-2xl md:text-3xl font-bold text-center mb-1 sm:mb-2">
              Welcome To <span className="text-[#006666]">P-DIFY</span>
            </h2>
            <p className="text-center text-gray-600 mb-3 sm:mb-4 text-xs sm:text-sm">Join our community</p>

            <form className="space-y-2 sm:space-y-2.5 md:space-y-0" onSubmit={handleSubmit}>
              ...
              {userType === "official" && (
                <div className="animate-slideDown">
                  <label className="block text-xs sm:text-sm font-semibold text-gray-700 mb-1">Passkey</label>
                  <input
                    type="password"
              ...
              {/* FACULTY */}
              <div>
                <label className="block text-xs sm:text-sm font-semibold text-gray-700 mb-1">Faculty</label>
                <select
                  value={faculty}
            ...
            <p className="text-center mt-2 sm:mt-3 text-xs sm:text-sm text-gray-600">
              ...
              <a href="/login" className="text-[#006666] font-bold hover:underline">
                Log in
              </a>
            </p>
