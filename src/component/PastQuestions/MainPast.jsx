        ...
        <div className="container bg-[#DFECEC] w-full rounded-2xl flex flex-wrap flex-col items-center justify-center p-[3rem] gap-10 mt-10">
          ...
          <div className="flex flex-wrap items-center justify-center gap-[5rem] text-center">
            ...
            <div className="flex flex-col items-center">
              ...
              <h3 className="font-bold text-[1.3rem]">Search for pastquestions</h3>
              <p className="text-gray-900">Instantly find and study past exam papers</p>
              <p className="text-gray-900">Handpicked, organized, and always available</p>
            </div>
            ...
            <div className="flex flex-col items-center">
              ...
              <h3 className="font-bold text-[1.3rem]">Test Your Knowledge</h3>
