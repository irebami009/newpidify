...
const FpasSidebar = () => {
  ...
  const PastQuestionsDepartment = [
    { name: "Computer Science", path: "/computer-science/100level" },
    { name: "Software Engineering", path: "/software-engineering-pq/100" },
    { name: "Cyber Security", path: "/cyber-security-pq/100" },
    { name: "Micro-Biology", path: "/micro-biology-pq/100" },
    { name: "Bio-Chemistry", path: "/bio-chemistry-pq/100" },
  ];

  const CourseMaterialsDepartment = [
    { name: "Computer Science", path: "/computer-science-pdf/100" },
    { name: "Software Engineering", path: "/software-engineering/100" },
    { name: "Cyber Security", path: "/cyber-security/100" },
    { name: "Micro-Biology", path: "/micro-biology/100" },
    { name: "Bio-Chemistry", path: "/biochemistry/100" },
  ];
    ...
    <>
      ...
      >
        ...
        <div className="flex items-center justify-between mb-8 pb-4 border-b border-white/10 shrink-0">
          <Link to="/dashboard/fpas" className="flex items-center gap-2.5">
