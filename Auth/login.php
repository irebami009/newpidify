...
$stmt = $conn->prepare("SELECT id, fullname, password, faculty, role, profile_picture FROM users WHERE email = ?");
if (!$stmt) {
...
$stmt->bind_result($id, $fullname, $hashedPassword, $faculty, $role, $profile_picture);
$stmt->fetch();
